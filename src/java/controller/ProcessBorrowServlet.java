...
public class ProcessBorrowServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String idUser = (String) request.getSession().getAttribute("idUser"); // Retrieve as Integer
        ...
        try (Connection connection = DriverManager.getConnection(JDBC_URL, JDBC_USERNAME, JDBC_PASSWORD)) {
            ...
            String insertPeminjaman = "INSERT INTO peminjaman (idTransaksi, idItem, idUser, tanggalTransaksi, tanggalKembali) VALUES (?, ?, ?, ?, ?)";
